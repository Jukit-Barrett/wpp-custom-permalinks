        ...
        <div class="wrap">
            <div class="float">
                ...
                <div class="tagline">
                    ...
                    <p>
                        ...
                        ?>
                        <a href="https://wordpress.org/support/plugin/custom-permalinks/reviews/?rate=5#new-post"
                           title="Custom Permalinks Rating" target="_blank">
                            <?php
            ...
            <div class="float">
                ...
                <img src="<?php echo $img_src . '/custom-permalinks.svg'; ?>"
                     alt="<?php esc_html_e('Custom Permalinks', 'custom-permalinks'); ?>"
                     title="<?php esc_html_e('Custom Permalinks', 'custom-permalinks'); ?>"/>
            </div>
            ...
            <div class="product">
                ...
                <div class="box recommended">
                    <div class="img">
                        <?php // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
                        <img src="<?php echo $img_src . '/prevent-xss-vulnerability.png'; ?>"
                             alt="<?php esc_html_e('Prevent XSS Vulnerability', 'custom-permalinks'); ?>"
                             title="<?php esc_html_e('Prevent XSS Vulnerability', 'custom-permalinks'); ?>"
                    ...
                    <a href="https://wordpress.org/plugins/prevent-xss-vulnerability/" class="checkout-button"
                       title="<?php esc_html_e('Prevent XSS Vulnerability', 'custom-permalinks'); ?>" target="_blank">
                ...
                <div class="box recommended">
                    <div class="img">
                        ...
                        <img src="<?php echo $img_src . '/http-auth.svg'; ?>"
                             alt="<?php esc_html_e('HTTP Auth', 'custom-permalinks'); ?>"
                             title="<?php esc_html_e('HTTP Auth', 'custom-permalinks'); ?>"/>
                    </div>
                    ...
                    <a href="https://wordpress.org/plugins/http-auth/" class="checkout-button"
                       title="<?php esc_html_e('HTTP Auth', 'custom-permalinks'); ?>" target="_blank">
                        <?php esc_html_e('Check it out', 'custom-permalinks'); ?>
                    </a>
                </div>
                ...
                <div class="box">
                    <div class="img">
                        ...
                        <img src="<?php echo $img_src . '/make-paths-relative.svg'; ?>"
                             alt="<?php esc_html_e('Make Paths Relative', 'custom-permalinks'); ?>"
                             title="<?php esc_html_e('Make Paths Relative', 'custom-permalinks'); ?>"/>
                    </div>
                    ...
                    <a href="https://wordpress.org/plugins/make-paths-relative/" class="checkout-button"
                       title="<?php esc_html_e('Make Paths Relative', 'custom-permalinks'); ?>" target="_blank">
                        <?php esc_html_e('Check it out', 'custom-permalinks'); ?>
                    </a>
                </div>
                ...
                <div class="box">
                    <div class="img">
                        ...
                        <img src="<?php echo $img_src . '/schema-for-article.svg'; ?>"
                             alt="<?php esc_html_e('SCHEMA for Article', 'custom-permalinks'); ?>"
                             title="<?php esc_html_e('SCHEMA for Article', 'custom-permalinks'); ?>"/>
                    </div>
                    ...
                    <a href="https://wordpress.org/plugins/schema-for-article/" class="checkout-button"
                       title="<?php esc_html_e('SCHEMA for Article', 'custom-permalinks'); ?>" target="_blank">
                        <?php esc_html_e('Check it out', 'custom-permalinks'); ?>
                    </a>
                </div>
                ...
                <div class="box">
                    <div class="img">
                        ...
                        <img src="<?php echo $img_src . '/remove-links-and-scripts.svg'; ?>"
                             alt="<?php esc_html_e('Remove Links and Scripts', 'custom-permalinks'); ?>"
                             title="<?php esc_html_e('Remove Links and Scripts', 'custom-permalinks'); ?>"/>
                    </div>
                    ...
                    <a href="https://wordpress.org/plugins/remove-links-and-scripts/" class="checkout-button"
                       title="<?php esc_html_e('Remove Links and Scripts', 'custom-permalinks'); ?>" target="_blank">
                        <?php esc_html_e('Check it out', 'custom-permalinks'); ?>
                    </a>
                </div>
                ...
                <div class="box">
                    <div class="img">
                        ...
                        <img src="<?php echo $img_src . '/media-post-permalink.png'; ?>" style="transform:scale(1.5)"
                             alt="<?php esc_html_e('Media Post Permalink', 'custom-permalinks'); ?>"
                             title="<?php esc_html_e('Media Post Permalink', 'custom-permalinks'); ?>"/>
                    </div>
                    ...
                    <a href="https://wordpress.org/plugins/media-post-permalink/" class="checkout-button"
                       title="<?php esc_html_e('Media Post Permalink', 'custom-permalinks'); ?>" target="_blank">
                        <?php esc_html_e('Check it out', 'custom-permalinks'); ?>
                    </a>
                </div>
                ...
                <div class="box">
                    <div class="img">
                        ...
                        <img src="<?php echo $img_src . '/json-structuring-markup.svg'; ?>"
                             alt="<?php esc_html_e('JSON Structuring Markup', 'custom-permalinks'); ?>"
                             title="<?php esc_html_e('JSON Structuring Markup', 'custom-permalinks'); ?>"/>
                    </div>
                    ...
                    <a href="https://wordpress.org/plugins/json-structuring-markup/" class="checkout-button"
                       title="<?php esc_html_e('JSON Structuring Markup', 'custom-permalinks'); ?>" target="_blank">
                        <?php esc_html_e('Check it out', 'custom-permalinks'); ?>
                    </a>
                </div>
            </div>
